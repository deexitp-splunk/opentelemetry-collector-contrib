...
func (r *podmanReceiverStruct) start(context.Context, component.Host) error {
...
func (r *podmanReceiverStruct) scrape(context.Context) (pdata.Metrics, error) {
	var err error
